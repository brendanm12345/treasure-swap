...
const token_name = 'Heirloom';
const token_symbol = 'LOOM';
...
async function addLiquidity(amountEth, maxSlippagePct) {
  var pool_state = await getPoolState();
...
async function swapETHForTokens(amountEth, maxSlippagePct) {
  var pool_state = await getPoolState();
  var max_exchange_rate = Math.round((1 + maxSlippagePct / 100) * exchange_rate_multiplier * pool_state.eth_token_rate);
